                ...
                if year == selected_year:
                    ...
                    if age < spec_min_age:
                        ...
                        if age > spec_max_age:
                            ...
                            print(f'\nThe overall min life expectancy is: {minimum} from {minimum_country} in {minimum_year}')
                            ...
                            print(f'The minimum life expectancy was in {spec_min_country} with {spec_min_age}')